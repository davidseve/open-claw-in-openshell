...
- **Inference**: Red Hat MaaS (LiteLLM) → Claude Sonnet 4.6 (`maas/claude-sonnet-4-6`; GPT-OSS and Llama Scout kept in catalog as disabled backups)
...
| Endpoint | Purpose |
|---|---|
| `inference.local` (OpenShell privacy router) | LLM inference (routed to MaaS by the gateway) |
